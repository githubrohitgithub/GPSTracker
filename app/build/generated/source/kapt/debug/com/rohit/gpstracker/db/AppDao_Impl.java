...
import com.rohit.gpstracker.model.Owner;
import com.rohit.gpstracker.model.RepositoryData;
import com.rohit.gpstracker.model.TypeConverterOwner;
  ...
  public AppDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRepositoryData = new EntityInsertionAdapter<RepositoryData>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, RepositoryData value) {
        ...
        final String _tmp = __typeConverterOwner.someObjectListToString(value.getOwner());
        if (_tmp == null) {
          stmt.bindNull(4);
        } else {
